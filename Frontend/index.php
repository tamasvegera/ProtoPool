					...
					<div class="card">
						<div class="card-body">			
							...
							<table class="table table-sm" cellspacing="4" cellpadding="2">
								<tbody>
									<tr><th align="right">Current block:</th><td><?php include 'current_block.php';?></td></tr>
									<tr><th align="right">Network hashrate:</th><td><?php include 'net_hr.php';?></td></tr>
			...
			<div class="row">
				<div class="col-lg-12">
					<div class="card">
						...
						<div class="card-footer"><i class="fas fa-exclamation-triangle"></i> Don't forget to define the algo as Pascal as you can see in the example.</div>
					</div>
				</div>
				<div class="col-lg-12">
					<div class="card">
